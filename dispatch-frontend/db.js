    ...
    async searchByIc(rawIc) {
        ...
        if (activeBatch) {
            ...
            const merged = {
                ...
                addition_refund_penalty: commission ? commission.addition_refund_penalty : 0,
                addition_others: commission ? commission.addition_others : 0,
                addition_sorter: commission ? commission.addition_sorter : 0,
                addition_extra_reward: commission ? commission.addition_extra_reward : 0,
        ...
        try {
            ...
            return recordsList.map(item => {
                ...
                return {
                    ...
                    addition_refund_penalty: comm.additionRefundPenalty || 0,
                    addition_others: comm.additionOthers || 0,
                    addition_sorter: comm.additionSorter || 0,
                    addition_extra_reward: comm.additionExtraReward || 0,
