    ...
    const formattedRecords = await Promise.all(records.map(async (r) => {
      ...
      return {
        ...
        deduction: {
          ...
          deductionOthers: parseFloat(r.deduction_others || 0),
          deductionPendingCod: parseFloat(r.deduction_pending_cod || 0),
          deductionHqPenalty: parseFloat(r.deduction_hq_penalty || 0),
          deductionDuitnowPenalty: parseFloat(r.deduction_duitnow_penalty || 0),
          deductionLateCodPenalty: parseFloat(r.deduction_late_cod_penalty || 0),
          deductionLostIndividual: parseFloat(r.deduction_lost_individual || 0),
          ...
          deductionLostParcelHub: parseFloat(r.deduction_lost_parcel_hub || 0),
